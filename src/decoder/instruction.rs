use crate::{Error, OPCODE_NAMES, Reader, Result};
...
impl Instruction {
    pub(crate) const fn new(word: u32, aux: u32) -> Self {
        Self { word, aux }
    }

    pub const fn opcode(&self) -> Opcode {
        OPCODES[(self.word & 0xFF) as usize]
    }
...
pub const OPCODES: [Opcode; 83] = [
    ...
    Opcode::FORNLOOP,
    Opcode::FORGLOOP,
    Opcode::FORGPREP_INEXT,
    Opcode::FASTCALL3,
    Opcode::FORGPREP_NEXT,
    Opcode::NATIVECALL,
    Opcode::GETVARARGS,
    Opcode::DUPCLOSURE,
    Opcode::PREPVARARGS,
...
pub const HAX_AUX: [bool; 255] = const {
    let mut map = [false; 255];

    map[Opcode::GETGLOBAL as usize] = true;
    map[Opcode::SETGLOBAL as usize] = true;
    map[Opcode::GETIMPORT as usize] = true;
    map[Opcode::GETTABLEKS as usize] = true;
    map[Opcode::NAMECALL as usize] = true;
    map[Opcode::JUMPIFEQ as usize] = true;
    map[Opcode::JUMPIFLE as usize] = true;
    map[Opcode::JUMPIFLT as usize] = true;
    map[Opcode::JUMPIFNOTEQ as usize] = true;
    map[Opcode::JUMPIFNOTLE as usize] = true;
    map[Opcode::JUMPIFNOTLT as usize] = true;
    map[Opcode::NEWTABLE as usize] = true;
    map[Opcode::FORGLOOP as usize] = true;
    map[Opcode::FASTCALL3 as usize] = true;
    map[Opcode::LOADKX as usize] = true;
    map[Opcode::FASTCALL2 as usize] = true;
    map[Opcode::FASTCALL2K as usize] = true;
    map[Opcode::JUMPXEQKNIL as usize] = true;
    map[Opcode::JUMPXEQKB as usize] = true;
    map[Opcode::JUMPXEQKN as usize] = true;
    map[Opcode::JUMPXEQKS as usize] = true;
